...
const SettingForm = ({ id, name,  chatBot }: Props) => {
  const {
    register,
    onUpdateSettings,
    errors,
  ...
  return (
    <form className="flex flex-col gap-3 pb-10 " onSubmit={onUpdateSettings}>
      ...
      <div className="flex flex-col gap-3 mt-5 ">
        ...
        <div className='grid md:grid-cols-2'>
            ...
            <EditChatbotIcon
              ...
              errors={errors}
            />
            {/*  to check why i can't see the placeholder message  */}
            <WelcomeMessage
      ...
      <div className="flex gap-5 md:justify-center justify-center">
        <Button
